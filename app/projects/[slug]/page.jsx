        ...
        <main className="min-h-screen bg-[#121212] text-white pt-24 pb-12">
            <div className="max-w-5xl mx-auto px-6 md:px-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                    ...
                    >
                        <span className="text-purple-400 font-mono mb-4 text-lg">{project.category}</span>
                ...
                >
                    <div className="md:col-span-2 space-y-8">
                        <h2 className="text-3xl font-bold border-l-4 border-purple-500 pl-4">Overview</h2>
