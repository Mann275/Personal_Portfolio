...
export default function About() {
    ...
    const toRotate = ["Full Stack Developer", "Frontend Developer", "MERN Stack Developer"];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed mb-8">
                            I’m a Computer Science graduate and full-stack developer focused on building clean, scalable web applications using the MERN stack. I enjoy turning ideas into real products with solid UI, reliable backend logic, and performance in mind. Currently looking for opportunities to grow as a full-stack developer and contribute to real-world projects.
                        </p>
                        <div className="flex gap-4">
                            <a href="#contact" className="bg-white/90 text-black px-6 py-3 rounded-full font-semibold hover:bg-white transition-opacity opacity-80 hover:opacity-100">
                                Contact Me
                            </a>
                            <a href="/Mann.pdf" download className="border border-white text-white px-6 py-3 rounded-full font-semibold hover:bg-white/10 transition-colors">
                                Download Resume
                            </a>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="bg-white/5 p-4 rounded-xl border border-white/10 text-left hover:border-purple-500/30 transition-colors">
                            ...
                            <p className="text-gray-400 text-sm">B.Tech Computer Science and Engineering</p>
                        ...
                        {/* Kendriya Vidyalaya */}
                        <div className="bg-white/5 p-4 rounded-xl border border-white/10 text-left hover:border-purple-500/30 transition-colors">
                            <h4 className="text-lg font-bold text-white">Kendriya Vidyalaya No.1</h4>
                            <p className="text-gray-400 text-sm">Completed Higher Secondary</p>
                            <div className="flex justify-between items-center mt-3 border-t border-white/5 pt-3">
