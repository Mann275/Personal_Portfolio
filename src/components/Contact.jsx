...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="bg-[#121212] py-24 px-6 md:px-12 text-white border-t border-white/10"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-white hover:bg-white/20 hover:text-purple-400 transition-all"
                >
                  <FaGithub className="text-2xl" />
                </a>
                <a
                  href="https://www.linkedin.com/in/mann-patel-ba084625a/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="http://instagram.com/mann.275"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-white hover:bg-white/20 hover:text-pink-400 transition-all"
                >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {submitMessage && (
                <p
                  className={`text-sm font-semibold ${submitMessage.includes("❌") ? "text-red-400" : "text-green-400"}`}
                >
                  {submitMessage}
                </p>
              )}
