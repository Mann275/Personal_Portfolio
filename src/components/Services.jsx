...
const services = [
  {
    ...
    description:
      "I build responsive, high-performance web applications using React.js, Next.js, and Tailwind CSS. My focus is on creating seamless user experiences with clean code and modern design patterns.",
    features: [
      "SPA Development",
  ...
  },
  {
    ...
    description:
      "I develop scalable backend systems with Node.js, Express, and MongoDB. From API design to database management, I ensure your application is robust, secure, and efficient.",
    features: [
      "RESTful API Design",
      "Database Modeling",
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-8">
          {services.map((service, idx) => (
            ...
            >
              ...
              <div className="flex items-center text-purple-400 text-sm font-medium group-hover:text-white transition-colors mt-6">
