...
export default function Skills() {
  return (
    <section id="skills" className="bg-[#121212] py-24 px-6 md:px-12 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {skillCategories.map((cat, idx) => (
            ...
            >
              <h3 className="text-xl font-semibold mb-4 text-gray-200 border-b border-white/10 pb-2 text-center">
                {cat.title}
              </h3>
